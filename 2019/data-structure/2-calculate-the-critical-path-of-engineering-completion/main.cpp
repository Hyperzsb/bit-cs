...
void
PrimaryRoute(int start, int **node_to_routes, int **node_from_routes, int node_num, List<int> &ans_list, int ans_len) {
...
//              int tmp = ans_list.popFront();
//              ans_list.pushBack(tmp);
//              printf("%d-", tmp);
//          }
//          printf(" SUM: %d than: ", ans_len);
//          for (int i = 0; i < num; i++) {
...
int main() {
    ...
    if (flag) {
//      printf("node_to_routes:\n");
//      for (int i = 0; i < node_num; i++) {
//          printf("%d: ", i);
//          for (int j = 0; j < node_num; j++) {
//              printf("%d ", node_to_routes[i][j]);
//          }
//          printf("\n");
//      }
//      printf("node_from_routes:\n");
//      for (int i = 0; i < node_num; i++) {
//          printf("%d: ", i);
//          for (int j = 0; j < node_num; j++) {
//              printf("%d ", node_from_routes[i][j]);
//          }
//          printf("\n");
//      }
        List<int> ans_list;
